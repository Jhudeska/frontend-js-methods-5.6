...
if( fruit.length > vegetable.length ){
    ...
    console.log( fruit + " " + fruit.length + " is not langer dan " + vegetable + " " + vegetable.length + " vegetables" );
}
...
console.log(story.slice(0, story.indexOf(" Fantastisch")));
